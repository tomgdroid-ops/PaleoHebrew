    ...
    <div className="report-page">
      ...
      <table>
        <tbody>
          ...
          {word.lemma && (
            <tr>
              <td style={{ fontWeight: 700 }}>Strong&apos;s Number</td>
              <td>{word.lemma}</td>
            </tr>
          )}
          {gloss?.translit && (
            <tr>
              ...
              <td>{gloss.translit} (Strong&apos;s) / {decoded.translit} (phonetic)</td>
            </tr>
          )}
          {morphDecoded && (
            <tr>
      ...
      <p style={{ fontSize: "11px", color: "#888" }}>
        Source: Strong&apos;s Hebrew Concordance via the Open Scriptures Hebrew Bible (OSHB), CC BY 4.0
      </p>
      ...
      <p style={{ fontSize: "12px", marginBottom: "12px" }}>
        ...
        based on four factors: primary meaning usage, alignment with Strong&apos;s
        definition, grammatical naturalness, and theological coherence.
      </p>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td style={{ fontWeight: 600 }}>Strong&apos;s Alignment</td>
            <td style={{ textAlign: "center" }}>25</td>
            <td>Rewards sentences whose keywords overlap with the Strong&apos;s Concordance definition.</td>
          </tr>
          <tr>
      ...
      <div className="footer">
        <p>
          Generated by <strong>Torah Decoder</strong> &mdash; paleo-hebrew-decoder.vercel.app
        </p>
        <p>
          Data sources: Open Scriptures Hebrew Bible (CC BY 4.0) &bull; Strong&apos;s Hebrew Concordance
        </p>
